...
public class ExtraLife extends GameObj {
	public static final String img_file_extraLife = "extraLife.png";
	public static final int SIZE = 30;
	public static final int INIT_VEL_X = 0;
	public static final int INIT_VEL_Y = 4;

	public static BufferedImage img_extraLife;
	...
	public ExtraLife(int courtWidth, int courtHeight) {
		super(INIT_VEL_X, INIT_VEL_Y, courtWidth / 2 - SIZE / 2, 100, SIZE,
				...
				Color.black, 0, 1);
		try {
			if (img_extraLife == null) {
				img_extraLife = ImageIO.read(new File(img_file_extraLife));
			}
		} catch (IOException e) {
	...
	public void draw(Graphics g) {
		...
		gd.drawImage(img_extraLife, pos_x, pos_y, width, height, null);
		gd.setComposite(AlphaComposite.getInstance(
