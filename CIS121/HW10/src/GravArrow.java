 ...
 * is invoked.
 */
public class GravArrow extends GameObj {
	public static final String img_file_gravArrow = "arrow.png";
	...
	public GravArrow(int courtWidth, int courtHeight) {
		super(INIT_VEL_X, INIT_VEL_Y, courtWidth / 2 - SIZE / 2, 100, SIZE,
				SIZE, courtWidth, courtHeight, 0, Color.black, 
				Color.black, 0, 1);
		try {
			if (img_arrow == null) {
				img_arrow = ImageIO.read(new File(img_file_gravArrow));
			}
		} catch (IOException e) {
	...
	public void draw(Graphics g) {
		...
		gd.drawImage(img_arrow, pos_x, pos_y, width, height, null);
		gd.setComposite(AlphaComposite.getInstance(
